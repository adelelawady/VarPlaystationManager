...
import { getTableIdentifier } from 'app/entities/table/table.model';
...
export class PosService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/pos/tables');

  constructor(protected http: HttpClient, protected applicationConfigService: ApplicationConfigService) {}

  create(table: any): Observable<EntityResponseType> {
