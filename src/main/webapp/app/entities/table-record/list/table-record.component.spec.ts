...
describe('TableRecord Management Component', () => {
  let comp: TableRecordComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TableRecordComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tableRecords?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
