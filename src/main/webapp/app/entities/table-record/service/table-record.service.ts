...
import { ITableRecord, getTableRecordIdentifier } from '../table-record.model';
...
export class TableRecordService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/table-records');
