 ...
 * A Table.
 */
@Document(collection = "ordersRecord")
public class OrderHandlerDomain extends AbstractAuditingEntity implements Serializable {
    ...
    @Field("type")
    private TABLE_TYPE type = TABLE_TYPE.CAFE;
    ...
    public OrderHandlerDomain id(String id) {
        this.setId(id);
        return this;
    }
    ...
    public OrderHandlerDomain name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public OrderHandlerDomain discount(Double discount) {
    ...
    public OrderHandlerDomain totalPrice(Double totalPrice) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderHandlerDomain)) {
            return false;
        }
        return id != null && id.equals(((OrderHandlerDomain) o).id);
    }
