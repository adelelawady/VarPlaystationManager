...
public class Sheft extends AbstractAuditingEntity implements Serializable {
    ...
    public Double getTotal_discount_price_time_devices() {
        return total_discount_price_time_devices;
    }

    public void setTotal_discount_price_time_devices(Double total_discount_price_time_devices) {
        this.total_discount_price_time_devices = total_discount_price_time_devices;
    }

    public Double getTotal_discount_price_orders_devices() {
        return total_discount_price_orders_devices;
    }

    public void setTotal_discount_price_orders_devices(Double total_discount_price_orders_devices) {
        this.total_discount_price_orders_devices = total_discount_price_orders_devices;
    }

    public Double getTotal_net_price_after_discount_devices() {
        return total_net_price_after_discount_devices;
    }

    public void setTotal_net_price_after_discount_devices(Double total_net_price_after_discount_devices) {
        this.total_net_price_after_discount_devices = total_net_price_after_discount_devices;
    }
