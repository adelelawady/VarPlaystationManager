...
public class ReceiptPlayGroundPrint implements Printable {

    public PlaygroundRecord currentRecord = new PlaygroundRecord();

    public ReceiptPlayGroundPrint(PlaygroundRecord rec) {
        currentRecord = rec;
    }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        line += 13;
        g2d.drawString(String.format("%-25s", "---- PLAY GROUND ----"), 1, line);
        line += 13;
        ...
        if (currentRecord.getOrdersData() != null && !currentRecord.getOrdersData().isEmpty()) {
            try {
                ...
                for (Product prod : currentRecord.getOrdersData()) {
                    ...
                    g2d.drawString(toCodedString(itemid), 2, cH);
